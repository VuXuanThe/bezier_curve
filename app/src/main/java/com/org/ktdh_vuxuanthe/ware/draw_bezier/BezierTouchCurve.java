...
import com.org.ktdh_vuxuanthe.ware.bezier_algorithm.NormalSizeHelper;
import com.org.ktdh_vuxuanthe.ware.bezier_algorithm.ShaderHelper;
import com.org.ktdh_vuxuanthe.ware.gl_es.Buffers;
import com.org.ktdh_vuxuanthe.ware.util.Const;
import com.yalantis.waves.util.TextureHelper;
...
//        GLES20.glClear(GLES20.GL_DEPTH_BUFFER_BIT | GLES20.GL_COLOR_BUFFER_BIT);
    ...
    public void touchUp() {
        ...
        for (int i = 0; i < mBezierList.size(); i++) {
            ...
            Log.d("value_ log_point","start point x is " + mBezierList.get(i).startPoint.x + " end point is y" + mBezierList.get(i).endPoint.y);

            Log.d("value_ log_list",
